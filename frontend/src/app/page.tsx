...
export default function HomePage() {
  ...
  return (
    <main className="verdant-page min-h-screen py-4 sm:py-6">
      <div className="verdant-layout relative z-10 grid w-full grid-cols-1 gap-4 px-3 sm:px-5 lg:grid-cols-[270px_minmax(0,1fr)_300px]">
        <aside className="verdant-card hidden self-start rounded-[20px] p-[18px] lg:sticky lg:top-[74px] lg:block lg:h-fit">
        ...
        <aside className="hidden self-start space-y-4 lg:sticky lg:top-[74px] lg:block lg:h-fit">
