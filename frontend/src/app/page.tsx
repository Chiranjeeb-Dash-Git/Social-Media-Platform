...
export default function HomePage() {
  ...
  return (
    <main className="verdant-page min-h-screen py-4 sm:py-6">
      <div className="relative z-10 mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-4 px-3 sm:px-5 lg:grid-cols-[270px_minmax(0,1fr)_300px]">
        <aside className="verdant-card hidden rounded-[20px] p-[18px] lg:sticky lg:top-20 lg:block lg:h-fit">
        ...
        <aside className="hidden space-y-4 lg:sticky lg:top-20 lg:block lg:h-fit">
